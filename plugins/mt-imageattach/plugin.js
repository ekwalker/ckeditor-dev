...
(function() {
	...
	var pasteImageCmd = {
		...
		exec: function(editor) {
			...
			var lang = editor.lang['mt-imageattach'],
				status, msg = '';
	...
	CKEDITOR.plugins.add('mt-imageattach', {
		icons: 'pasteimage',
		requires: 'dialog,mt-dialog,mt-save',
		lang: 'en',
		init: function(editor) {
			editor.addCommand('pasteimage', pasteImageCmd);
			editor.ui.addButton('PasteImage', {
				label: editor.lang['mt-imageattach'].pasteFromClipboard,
				command: 'pasteimage'
			});
